...
*/
  final public String Analizar() throws ParseException {ArrayList<String> ins = new ArrayList<String>(); String e;
    label_1:
    while (true) {
      e = Instruccion();
    ...
    jj_consume_token(0);
System.out.println("END OF FILE"); System.out.println("Instruccion " + e); {if ("" != null) return new String(e);}
    throw new Error("Missing return statement in function");
}

  final public String Instruccion() throws ParseException {String e; Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEGER:{
...
System.out.println("STRING " + token.image);
        {if ("" != null) return new String(t.image.substring(1,t.image.length()-1));}
      break;
      }
    case IDENTIFICADOR:{
...
System.out.println("ID " + t.image);
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1800,0x1800,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x120,0x120,};
	}
