...
public class Trunk extends Funcion {
    ...
    public Object ejecutar(Tabla tabla, Arbol arbol) {
        ...
        Simbolo simbolo = tabla.getVariable(TRUNK_PARAMETRO);
        if (simbolo == null) {
        ...
        Integer truncated = ((Double)((Vector)simbolo.getValor()).getFirst()).intValue();


        return new Simbolo(new Tipo(Tipo.TipoDato.INTEGER, Tipo.TipoEstructura.VECTOR)
                , this.nombre, new Vector(Arrays.asList(truncated)));
    }
    ...
    public Object cargarTabla(Tabla tabla, Arbol arbol, ArrayList<AST> argumentos) {
        ...
        for (AST argumento : argumentos) {
            ...
            Simbolo simbolo = new Simbolo(argumento.getTipo(), TRUNK_PARAMETRO, result);
