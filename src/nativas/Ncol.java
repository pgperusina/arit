...
public class Ncol extends Funcion {
    ...
    public Object ejecutar(Tabla tabla, Arbol arbol) {
        ...
        Simbolo simbolo = tabla.getVariableLocal(NCOL_PARAMETRO);
        if (simbolo == null) {
        ...
        int numberOfCols = ((Matriz)simbolo.getValor()).getColumnas();

        return new Simbolo(new Tipo(Tipo.TipoDato.INTEGER, Tipo.TipoEstructura.VECTOR)
                , simbolo.getIdentificador(), new Vector(Arrays.asList(numberOfCols)));
    }
    ...
    public Object cargarTabla(Tabla tabla, Arbol arbol, ArrayList<AST> argumentos) {
        ...
        for (AST argumento : argumentos) {
            ...
            Simbolo simbolo = new Simbolo(argumento.getTipo(), NCOL_PARAMETRO, result);
