...
public class ToLowerCase extends Funcion {
    ...
    public Object ejecutar(Tabla tabla, Arbol arbol) {
        ...
        Simbolo simbolo = tabla.getVariable(TO_LOWER_CASE_PARAMETRO);
        if (simbolo == null) {
        ...
        String toLowerCase = ((Vector)simbolo.getValor()).getFirst().toString().toLowerCase();


        return new Simbolo(new Tipo(Tipo.TipoDato.STRING, Tipo.TipoEstructura.VECTOR)
                , this.nombre, new Vector(Arrays.asList(toLowerCase)));
    }
    ...
    public Object cargarTabla(Tabla tabla, Arbol arbol, ArrayList<AST> argumentos) {
        ...
        for (AST argumento : argumentos) {
            ...
            Simbolo simbolo = new Simbolo(argumento.getTipo(), TO_LOWER_CASE_PARAMETRO, result);
